...
static void setup_importlib()
{
	char const* code = "import sys\n"
		...
		"    pass\n"
		"\n"
		"class UFSExtensionFileLoader(UFSFileLoader, importlib.machinery.ExtensionFileLoader):\n"
		"    pass\n"
		"\n"
		...
		"    extension = UFSExtensionFileLoader, importlib.machinery.EXTENSION_SUFFIXES\n"
		...
		"    return [extension, source, bytecode]\n"
